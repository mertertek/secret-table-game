/**
 * Depo bağlantısı. Oyunu deneyen kişi kaynağın açık olduğunu GÖRMEDEN ayrılıyordu
 * (2026-09-19: bir paylaşımda ~3-4 bin görüntülenme, sıfır yıldız; arayüzde hiç
 * GitHub bağlantısı yoktu). Giriş ekranının altında ve oyun içi menüde durur.
 */
import { useT } from '../i18n';

export const REPO_URL = 'https://github.com/mertertek/secret-table-game';
...
export function SourceLink({ className }: { className?: string }) {
  ...
  return (
    <a className={className} href={REPO_URL} target="_blank" rel="noopener noreferrer">
      <svg viewBox="0 0 16 16" width="15" height="15" aria-hidden="true" focusable="false" fill="currentColor">
